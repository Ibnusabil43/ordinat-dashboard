...
export function ReviewTable({
  ...
  return (
    <div className="rounded-2xl border border-zinc-300 bg-white p-4 sm:p-6">
      <h2 className="text-lg font-semibold text-zinc-900">Review Kecocokan Nama</h2>
      <p className="mt-1 text-sm text-zinc-500">
        {pending.length} kecocokan nama punya skor kemiripan di bawah 90% — cek dan konfirmasi
        sebelum nilai ditulis ke Rekap. Yang tidak dicentang akan dianggap tidak ditemukan.
      </p>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-zinc-200 text-left text-xs font-medium text-zinc-500">
              ...
              <th className="px-2 py-2">Subtes</th>
              <th className="px-2 py-2">Nama di Rekap</th>
              <th className="px-2 py-2">Nama di RAW</th>
      ...
      >
        {busy ? "Mengirim..." : "Konfirmasi & Lanjutkan"}
      </button>
    </div>
  );
}
